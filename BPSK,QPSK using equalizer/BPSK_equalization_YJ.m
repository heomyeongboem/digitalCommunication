...
% %equalizer selection
 tap_number=7;%tap3,5,7 ,N the tap number needs to be a odd number
...
BER3=BPSK_tapN(3); % tap_number =3 일때 BER3
BER5=BPSK_tapN(5);%  tap_number =5 일때 BER5
 %{
figure,semilogy([Eb_No_start:Eb_No_step:Eb_No_end],BER,'r*-', ...
    [Eb_No_start:Eb_No_step:Eb_No_end],BER5,'go-', ...
    [Eb_No_start:Eb_No_step:Eb_No_end],BER3,'b.-');
%}
figure,semilogy([Eb_No_start:Eb_No_step:Eb_No_end],BER,'r*-');

%legend('7-tap ZFE','5-tap ZFE','3-tap ZFE')
xlabel('E_b/N_o(dB)'); ylabel('P_b'); set(gca,'xlim',[-1 20], 'ylim',[10^(-6) 1]);
